...
fn main() {
    ...
    let mut cam = Camera::new(lookfrom, lookat, vup, 20.0, aspect_ratio, aperture, dist_to_focus);
...
fn random_limit(_min: f64, _max: f64) -> Vec3 {
    return Vec3::new(random_double_limit(_min, _max), random_double_limit(_min, _max), random_double_limit(_min, _max));
}
...
fn random_scene() -> Hlist {
    ...
    // let m1 = Arc::<Lambertian>::new(Lambertian::new(Vec3::new(0.7, 0.3, 0.3)));
    // let foo1 = Arc::<Sphere>::new(Sphere::new(Vec3::new(0.0, 0.0, -1.0), 0.5, m1.clone()));
    world.push(Arc::<Sphere>::new(Sphere::new(Vec3::new(0.0, -1000.0, 0.0), 1000.0,
    ...
    world.push(Arc::<Sphere>::new(Sphere::new(Vec3::new(0.0, 1.0, 0.0), 1.0,
               Arc::<Dielectric>::new(Dielectric::new(1.5)))));
    world.push(Arc::<Sphere>::new(Sphere::new(Vec3::new(-4.0, 1.0, 0.0), 1.0,
